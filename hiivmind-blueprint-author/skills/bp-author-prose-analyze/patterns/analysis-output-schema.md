...
> **Contract between:** bp-author-prose-analyze → bp-author-prose-migrate

# Analysis Output Schema

Complete field reference for the analysis YAML produced by `bp-author-prose-analyze` and consumed by `bp-author-prose-migrate`. This document is the handoff contract between the two skills.
...
## Consumer Notes for bp-author-prose-migrate

When consuming this schema, `bp-author-prose-migrate` should:
