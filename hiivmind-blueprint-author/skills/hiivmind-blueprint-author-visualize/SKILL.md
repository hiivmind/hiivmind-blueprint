...
description: >
  ...
  or when user wants to see how a workflow executes.
allowed-tools: Read, Glob, AskUserQuestion
---

# Visualize Workflow

Generate Mermaid diagrams from workflow.yaml files, supporting both end-to-end and subflow visualizations.

> **Pattern Documentation:** `${CLAUDE_PLUGIN_ROOT}/lib/blueprint/patterns/mermaid-generation.md`
...
{
  "questions": [{
    "question": "Which subflow would you like to visualize?",
    "header": "Subflows",
    "multiSelect": true,
    "options": [
...
classDef action fill:#F0F0F0,stroke:#696969
```
...
- **Mermaid Generation Pattern:** `${CLAUDE_PLUGIN_ROOT}/lib/blueprint/patterns/mermaid-generation.md`
...
- Analyze skills: `${CLAUDE_PLUGIN_ROOT}/skills/hiivmind-blueprint-author-analyze/SKILL.md`
- Convert to workflow: `${CLAUDE_PLUGIN_ROOT}/skills/hiivmind-blueprint-author-convert/SKILL.md`
- Discover workflows: `${CLAUDE_PLUGIN_ROOT}/skills/hiivmind-blueprint-author-discover/SKILL.md`
