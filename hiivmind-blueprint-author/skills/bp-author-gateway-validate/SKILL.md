---
name: bp-author-gateway-validate
description: >
  ...
  "questions": [{
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Run bp-author-skill-validate on referenced skills"
      },
      {
        "label": "Done",
...
HANDLE_NEXT_ACTION(response):
  SWITCH response:
    ...
    CASE "Validate individual skills":
      ...
      DISPLAY ""
      DISPLAY "  Skill(skill: \"bp-author-skill-validate\", args: \"<path-to-workflow.yaml>\")"
      DISPLAY ""
...
- **Validation Checklist:** `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-gateway-validate/patterns/gateway-validation-checklist.md`
...
- Intent mapping validation: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-intent-validate/SKILL.md`
