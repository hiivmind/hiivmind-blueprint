---
name: hiivmind-blueprint-author-discover
description: >
...
To convert a skill:
1. `/hiivmind-blueprint-author analyze {skill_name}`
2. `/hiivmind-blueprint-author convert`
3. `/hiivmind-blueprint-author generate`

Or use the gateway command:
`/hiivmind-blueprint-author convert {skill_name}`
```
