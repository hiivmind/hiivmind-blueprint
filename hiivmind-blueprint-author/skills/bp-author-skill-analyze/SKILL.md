...
It does NOT analyze prose-based SKILL.md files -- use `bp-author-prose-analyze` for that purpose.
...
HANDLE_NEXT_ACTION(response):
  SWITCH response:
    CASE "Refactor workflow":
      ...
      DISPLAY "  Skill(skill: 'bp-author-skill-refactor', args: '{computed.workflow_path}')"
    ...
    CASE "Validate workflow":
      ...
      DISPLAY "  Skill(skill: 'bp-author-skill-validate', args: '{computed.workflow_path}')"
    ...
    CASE "Visualize workflow":
      ...
      DISPLAY "  Skill(skill: 'bp-author-visualize', args: '{computed.workflow_path}')"
...
- Prose-based skill analysis: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-prose-analyze/SKILL.md`
- Workflow validation: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-skill-validate/SKILL.md`
- Workflow refactoring: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-skill-refactor/SKILL.md`
- Workflow visualization: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-visualize/SKILL.md`
- Plugin-level analysis: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-plugin-analyze/SKILL.md`
