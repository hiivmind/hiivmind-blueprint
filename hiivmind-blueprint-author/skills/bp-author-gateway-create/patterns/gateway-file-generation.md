...
| `{{lib_ref}}` | `BLUEPRINT_LIB_VERSION.yaml` | External lib reference | `hiivmind/hiivmind-blueprint-lib@v3.0.0` |
| `{{lib_version}}` | Extracted from `{{lib_ref}}` | Version tag only | `v3.0.0` |
