...
- Workflow analysis: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-skill-analyze/SKILL.md`
- Prose-based migration: `${CLAUDE_PLUGIN_ROOT}/skills-prose/bp-author-prose-migrate/SKILL.md`
