...
Valid type references for v3.0.0, deprecated type detection, and migration suggestions.

---

## Valid Precondition Types (v3.0.0)
...
## Valid Consequence Types (v3.0.0)
...
- **v3.0.0 Migration Guide:** `hiivmind/hiivmind-blueprint-lib@v3.0.0/docs/v3-migration.md`
