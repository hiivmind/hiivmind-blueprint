...
Complete reference for all 31 consequence types available in hiivmind-blueprint-lib v3.0.0.

> **Examples:** `hiivmind/hiivmind-blueprint-lib@v3.0.0/examples/consequences.yaml`
> **Definitions:** `hiivmind/hiivmind-blueprint-lib@v3.0.0/consequences/consequences.yaml`
