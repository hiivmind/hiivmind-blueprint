...
## Node Types → hiivmind-blueprint-lib

Node types should also be externalized to hiivmind-blueprint-lib for consistency.
...
### Phase 4: Create Node Type Definitions in hiivmind-blueprint-lib

**Repository:** `/home/nathanielramm/git/hiivmind/hiivmind-blueprint-lib`
...
### In hiivmind-blueprint-lib (separate repo)
...
6. **Node types in bundle** - Verify bundle.yaml includes all 5 node types from hiivmind-blueprint-lib
7. **Cross-repo consistency** - Verify hiivmind-blueprint-lib bundle.yaml matches lib/types/bundle.yaml
