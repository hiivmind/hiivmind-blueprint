...
Framework defaults are fetched from the type definitions library:
...
FUNCTION initialize(workflow_path, plugin_root, runtime_flags):
    ...
    # 3. Load and resolve logging config
...
```
Error: Failed to fetch logging defaults

Source: hiivmind/hiivmind-blueprint-lib@v2.0.0
URL: https://raw.githubusercontent.com/hiivmind/hiivmind-blueprint-lib/v2.0.0/logging/defaults.yaml
Error: 404 Not Found
