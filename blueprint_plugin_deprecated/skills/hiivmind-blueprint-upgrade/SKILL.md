...
**Invocation:**
- `/hiivmind-blueprint upgrade` - Auto-detect target type (ask if both found)
- `/hiivmind-blueprint upgrade skills` - Upgrade skill workflows only
- `/hiivmind-blueprint upgrade gateway` - Upgrade gateway workflows only
...
- Validate workflow: `${CLAUDE_PLUGIN_ROOT}/skills/hiivmind-blueprint-validate/SKILL.md`
