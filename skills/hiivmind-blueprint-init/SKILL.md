...
1. Analyze: `/hiivmind-blueprint analyze`
2. Convert: `/hiivmind-blueprint convert`
3. Generate: `/hiivmind-blueprint generate`
```
...
### Next Steps
1. Identify skills to convert with `/hiivmind-blueprint discover`
2. Analyze a skill with `/hiivmind-blueprint analyze [skill]`
