...
Core workflow execution logging for audit trails, debugging, and CI integration. These consequences are workflow-engine intrinsic and can be extended by plugins with custom event types.
...
- **Parent:** [README.md](../README.md) - Consequences overview
