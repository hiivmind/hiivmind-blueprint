...
mkdir -p ~/.claude/cache/hiivmind/blueprint/types/hiivmind/hiivmind-blueprint-types/v1.0.0/
cp bundle.yaml ~/.claude/cache/hiivmind/blueprint/types/hiivmind/hiivmind-blueprint-types/v1.0.0/
```
...
Suggestions:
- Check the version exists: https://github.com/hiivmind/hiivmind-blueprint-types/releases
...
Loaded from: hiivmind/hiivmind-blueprint-types@v1.0.0 (43 consequences)
