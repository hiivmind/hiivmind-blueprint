---
name: hiivmind-blueprint-ops-validate
description: >
...
- `/hiivmind-blueprint-ops validate schema` - JSON schema + yq structure validation only
- `/hiivmind-blueprint-ops validate graph` - Reachability, cycles, dead ends
- `/hiivmind-blueprint-ops validate types` - Precondition/consequence type validation
- `/hiivmind-blueprint-ops validate state` - State variable validation
- `/hiivmind-blueprint-ops validate --mode=full` - Explicit mode parameter
...
- Validate lib types: `${CLAUDE_PLUGIN_ROOT}/skills/hiivmind-blueprint-ops-lib-validation/SKILL.md`

**Cross-Plugin (hiivmind-blueprint-author):**
- Analyze skills: `/hiivmind-blueprint-author analyze`
- Discover workflows: `/hiivmind-blueprint-author discover`
